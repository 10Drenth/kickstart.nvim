--[[
 ...
 TODO: fix conflicts (CTRL Space) and listed in which_key
...
-- TODO: Add this to obsidian only config
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      incremental_selection = {
        enable = true,
        keymaps = {
          -- TODO: figure out how to add this to which key.
          init_selection = 'gnn',
